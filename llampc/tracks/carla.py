...
from llampc.tracks import Track
...
class CarlaTrack(Track):
	...
	def __init__(self, track_id, track_width, reference, longer):
		...
		self.mus = None
		super(CarlaTrack, self).__init__()
...
class CarlaRace(CarlaTrack):
	"""	Carla track
	"""

	def __init__(self, reference='center', longer=False):
		track_width = 3.4
		super(CarlaRace, self).__init__(
			track_id='', 
