...
from llampc.gp.utils import loadGPModel
from llampc.tracks import ETHZ
from llampc.mpc.planner import ConstantSpeed
from llampc.mpc.gpmpc_kin import setupNLP
...
for idt in range(n_steps-horizon):
	...
	xref, projidx, _ = ConstantSpeed(x0=x0[:2], v0=x0[3], track=track, N=horizon, Ts=Ts, projidx=projidx)
